...
## Purpose
Track the legal tech and CLM (Contract Lifecycle Management) competitive landscape to keep Evisort's product strategy informed by real market dynamics. Produces structured intelligence on competitor moves, market trends, buyer behavior shifts, and strategic implications — not just news aggregation, but assessed intelligence with a point of view.
...
- **Auto-loaded context** (read before processing):
  - `context/strategy/domain-expertise.md` — legal tech landscape knowledge
  - `context/competitors/matrix.md` — current competitive positioning data
  - `context/product-overview.md` — Evisort product context and differentiators
...
|----------|---------|-----------------|
| **Competitor announcements** | Ironclad, Icertis, DocuSign CLM, Agiloft, LinkSquares, Juro, SpotDraft, ContractPodAI — press releases, blogs, product updates | New features, partnerships, customer wins, pricing changes, leadership changes |
...
For each significant finding, analyze what it means for Evisort:

- **Threat assessment**: Does this narrow Evisort's differentiation? Open a new competitive front? Shift buyer expectations?
- **Opportunity assessment**: Does this validate Evisort's direction? Create a gap Evisort can exploit? Weaken a competitor's position?
...
- **12-24 month direction**: Where is the market heading? AI-native CLM? Self-service contracting? Legal workflow automation? Embedded contracts?
...
## Market Pulse
[3-5 sentences summarizing the current state of the legal tech / CLM market. What's the dominant narrative? What's shifting?]
...
|-----------|------------|------|-------------|-------------|
| [Name] | [What happened] | [Date] | [High/Med/Low] | [What Evisort can do about it] |
| [Name] | [What happened] | [Date] | [High/Med/Low] | [What Evisort can do about it] |
...
## Market Trends
1. **[Trend name]**: [Description and evidence] — Impact on Evisort: [assessment]
2. **[Trend name]**: [Description and evidence] — Impact on Evisort: [assessment]
3. **[Trend name]**: [Description and evidence] — Impact on Evisort: [assessment]

---

## Evisort Positioning Assessment
- **Strengthening**: [Where Evisort's position is improving and why]
...
- **Update domain expertise**: Add market trend insights to `context/strategy/domain-expertise.md`
- **Flag for innovation pipeline**: If market gaps or opportunities were identified, offer to add them to `context/strategy/innovation-pipeline.md`
...
- [ ] All major CLM competitors are covered (not just the top 2-3)
- [ ] Findings are from the specified time window — no stale intelligence
- [ ] Threat and opportunity assessments are specific to Evisort, not generic
...
- [ ] Positioning assessment is honest — not just optimistic about Evisort

## Integration Points
- **AI Research Scout**: AI developments relevant to legal tech are cross-referenced from AI scans
